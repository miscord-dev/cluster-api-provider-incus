...
import (
	...
	"github.com/miscord-dev/cluster-api-provider-incus/test/utils"
)
...
const metricsServiceName = "cluster-api-provider-incus-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "cluster-api-provider-incus-metrics-binding"
		...
		patch, _ := json.Marshal([]any{
			map[string]any{
				...
				"value": []string{
					...
					"--incus-oidc-token-file=/shared/oidctoken",
				},
			},
			map[string]any{
				"op":   "add",
	...
	Context("Manager", func() {
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=cluster-api-provider-incus-metrics-reader",
